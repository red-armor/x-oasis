...
```bash
npm install @x-oasis/is-null
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/is-null';
...
See the source code on [GitHub](https://github.com/d-band/x-oasis/tree/main/packages/assertion/is-null)
...
```typescript
import { /* types */ } from '@x-oasis/is-null';
```
