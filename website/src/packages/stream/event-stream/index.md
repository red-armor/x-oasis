...
Convert events to async streams

## Installation

```bash
npm install @x-oasis/event-stream
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/event-stream';
...
See the source code on [GitHub](https://github.com/d-band/x-oasis/tree/main/packages/stream/event-stream)
...
```typescript
import { /* types */ } from '@x-oasis/event-stream';
```
...
- Other packages in [stream](/packages/stream/)
