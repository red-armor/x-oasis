...
Hide property from enumeration

## Installation

```bash
npm install @x-oasis/hide-property
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/hide-property';
...
See the source code on [GitHub](https://github.com/d-band/x-oasis/tree/main/packages/proto/hide-property)
...
```typescript
import { /* types */ } from '@x-oasis/hide-property';
```
