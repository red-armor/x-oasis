...
| #     | 文件                                                                                                       | 标题                                       | 概述                                                                                                                           |
| ----- | ---------------------------------------------------------------------------------------------------------- | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ |
| P-001 | [20260515-orchestrator-sub-path-exports-plan.md](./roadmap/20260515-orchestrator-sub-path-exports-plan.md) | Orchestrator Sub-path Exports 分离实施计划 | 将 core + 3 adapter 包的 orchestrator 通过 sub-path exports 拆为 /core 和 /orchestrator，使基础 RPC 消费者零 orchestrator 体积 |
