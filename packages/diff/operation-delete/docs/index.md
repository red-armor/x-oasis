# @x-oasis/operation-delete

Handle deletion operations in diffs

## Installation

```bash
npm install @x-oasis/operation-delete
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/operation-delete';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/diff/operation-delete)
...
```typescript
import { /* types */ } from '@x-oasis/operation-delete';
```
