...
Diff/match/patch algorithms for text
...
```typescript
import { /* exports */ } from '@x-oasis/diff-match-patch';
...
See the source code on [GitHub](https://github.com/d-band/x-oasis/tree/main/packages/diff/diff-match-patch)
...
```typescript
import { /* types */ } from '@x-oasis/diff-match-patch';
```
