...
Parse and generate git-style diffs

## Installation

```bash
npm install @x-oasis/git-diff
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/git-diff';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/diff/git-diff)
...
```typescript
import { /* types */ } from '@x-oasis/git-diff';
```
