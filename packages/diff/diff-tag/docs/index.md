...
Tag-based diff algorithm

## Installation

```bash
npm install @x-oasis/diff-tag
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/diff-tag';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/diff/diff-tag)
...
```typescript
import { /* types */ } from '@x-oasis/diff-tag';
```
