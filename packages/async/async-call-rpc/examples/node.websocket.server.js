const {
  WebSocketChannel,
} = require('async-call-rpc/utils/node/websocket.server.js');
const {
  Msgpack_Serialization,
} = require('async-call-rpc/utils/node/msgpack.js');
...
AsyncCall(server, { channel, serializer: Msgpack_Serialization() });
