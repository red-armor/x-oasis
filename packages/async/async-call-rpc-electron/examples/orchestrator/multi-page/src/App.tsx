...
function getPageletId(pageId: PageId): string {
  return `pagelet-${pageId.replace('page', '').toUpperCase()}`;
}

function App(): JSX.Element {
  const [activePage, setActivePage] = useState<PageId>('pageA');
  ...
  const pageletId = getPageletId(activePage);
  ...
  const handleSwitchPage = useCallback(
    async (pageId: PageId) => {
      if (pageId === activePage || switching) return;
      setSwitching(true);
  ...
  return (
    ...
    >
            ...
            return (
              <button
                ...
                style={{
                  ...
                  border: 'none',
                  borderRadius: 8,
                  backgroundColor: isActive ? `${page.color}25` : 'transparent',
                  color: isActive ? page.color : '#94a3b8',
              ...
              >
                <span
                  style={{
                    ...
                    height: 28,
                    borderRadius: 6,
                    backgroundColor: isActive ? page.color : '#475569',
                ...
                <div>
                  ...
                  <div
                    style={{
                      fontSize: 10,
                      color: isActive ? `${page.color}99` : '#64748b',
                      lineHeight: '14px',
                    }}
                  >
                    {page.description}
      ...
      >
        <div
          style={{
            background: `linear-gradient(135deg, ${currentPage.color}dd 0%, ${currentPage.color}99 100%)`,
            padding: '12px 24px',
            color: '#fff',
            display: 'flex',
            alignItems: 'center',
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                border: 'none',
                borderRadius: 6,
                backgroundColor: isReady ? '#d1d5db' : currentPage.color,
                color: '#fff',
