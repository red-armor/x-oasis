 ...
 * main process via `IDaemonService.setSupervisorSnapshots`.
 *
 * This is the example's demo for D-004 §6 (manual restart, restart
 * history ring buffer, onStateChange) — the data is plain JSON
 * mirrored from `InspectorSnapshot` in @x-oasis/async-call-rpc-electron.
 */
