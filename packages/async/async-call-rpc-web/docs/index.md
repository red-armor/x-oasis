...
RPC channel implementations for web
...
```typescript
import { /* exports */ } from '@x-oasis/async-call-rpc-web';
...
See the source code on [GitHub](https://github.com/d-band/x-oasis/tree/main/packages/async/async-call-rpc-web)
...
```typescript
import { /* types */ } from '@x-oasis/async-call-rpc-web';
```
