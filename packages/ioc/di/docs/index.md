...
```bash
npm install @x-oasis/di
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/di';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/ioc/di)
...
- Other packages in [ioc](/packages/ioc/)
- Similar functionality in other categories

## See Also

- [Package Category](/packages/ioc/)
