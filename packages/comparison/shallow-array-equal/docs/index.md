...
```bash
npm install @x-oasis/shallow-array-equal
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/shallow-array-equal';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/comparison/shallow-array-equal)
...
```typescript
import { /* types */ } from '@x-oasis/shallow-array-equal';
```
