...
Detect which properties changed between objects

## Installation

```bash
npm install @x-oasis/resolve-changed
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/resolve-changed';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/comparison/resolve-changed)
...
```typescript
import { /* types */ } from '@x-oasis/resolve-changed';
```
