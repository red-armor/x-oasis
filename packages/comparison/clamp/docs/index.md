...
```bash
npm install @x-oasis/clamp
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/clamp';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/comparison/clamp)
...
```typescript
import { /* types */ } from '@x-oasis/clamp';
```
