...
```bash
npm install @x-oasis/shallow-equal
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/shallow-equal';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/comparison/shallow-equal)
...
```typescript
import { /* types */ } from '@x-oasis/shallow-equal';
```
