...
```typescript
import { /* exports */ } from '@x-oasis/web-stream';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/stream/web-stream)
...
```typescript
import { /* types */ } from '@x-oasis/web-stream';
```
