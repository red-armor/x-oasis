...
Assert conditions and throw on violations

## Installation

```bash
npm install @x-oasis/invariant
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/invariant';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/error/invariant)
...
```typescript
import { /* types */ } from '@x-oasis/invariant';
```
...
- Other packages in [error](/packages/error/)
- Similar functionality in other categories

## See Also

- [Package Category](/packages/error/)
