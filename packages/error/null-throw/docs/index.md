...
```bash
npm install @x-oasis/null-throw
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/null-throw';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/error/null-throw)
...
```typescript
import { /* types */ } from '@x-oasis/null-throw';
```
