...
```typescript
import { /* exports */ } from '@x-oasis/log';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/error/log)
