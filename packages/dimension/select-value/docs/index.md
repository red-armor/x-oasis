...
Calculate dimensions for selected values

## Installation

```bash
npm install @x-oasis/select-value
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/select-value';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/dimension/select-value)
...
```typescript
import { /* types */ } from '@x-oasis/select-value';
```
...
- Other packages in [dimension](/packages/dimension/)
- Similar functionality in other categories

## See Also

- [Package Category](/packages/dimension/)
