...
Compare layout dimensions and positions

## Installation

```bash
npm install @x-oasis/layout-equal
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/layout-equal';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/dimension/layout-equal)
...
```typescript
import { /* types */ } from '@x-oasis/layout-equal';
```
