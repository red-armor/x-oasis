...
Deferred promise - resolvable externally

## Installation

```bash
npm install @x-oasis/deferred
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/deferred';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/promise/deferred)
...
```typescript
import { /* types */ } from '@x-oasis/deferred';
```
...
- Other packages in [promise](/packages/promise/)
- Similar functionality in other categories

## See Also

- [Package Category](/packages/promise/)
