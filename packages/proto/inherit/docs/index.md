...
```bash
npm install @x-oasis/inherit
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/inherit';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/proto/inherit)
...
```typescript
import { /* types */ } from '@x-oasis/inherit';
```
