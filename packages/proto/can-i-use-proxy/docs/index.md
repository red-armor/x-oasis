...
```bash
npm install @x-oasis/can-i-use-proxy
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/can-i-use-proxy';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/proto/can-i-use-proxy)
...
```typescript
import { /* types */ } from '@x-oasis/can-i-use-proxy';
```
