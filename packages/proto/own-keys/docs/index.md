...
Get all own properties of object

## Installation

```bash
npm install @x-oasis/own-keys
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/own-keys';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/proto/own-keys)
...
```typescript
import { /* types */ } from '@x-oasis/own-keys';
```
