# @x-oasis/create-hidden-property
...
```bash
npm install @x-oasis/create-hidden-property
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/create-hidden-property';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/proto/create-hidden-property)
...
```typescript
import { /* types */ } from '@x-oasis/create-hidden-property';
```
...
- Other packages in [proto](/packages/proto/)
- Similar functionality in other categories

## See Also

- [Package Category](/packages/proto/)
