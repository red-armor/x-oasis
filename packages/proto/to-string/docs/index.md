...
```bash
npm install @x-oasis/to-string
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/to-string';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/proto/to-string)
...
```typescript
import { /* types */ } from '@x-oasis/to-string';
```
