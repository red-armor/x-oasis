...
Batch operations using last call
...
```typescript
import { /* exports */ } from '@x-oasis/batchinate-last';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/schedule/batchinate-last)
...
```typescript
import { /* types */ } from '@x-oasis/batchinate-last';
```
