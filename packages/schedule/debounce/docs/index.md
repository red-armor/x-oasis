...
```typescript
import { /* exports */ } from '@x-oasis/debounce';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/schedule/debounce)
...
```typescript
import { /* types */ } from '@x-oasis/debounce';
```
