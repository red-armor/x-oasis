...
```typescript
import { /* exports */ } from '@x-oasis/batchinator';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/schedule/batchinator)
...
```typescript
import { /* types */ } from '@x-oasis/batchinator';
```
