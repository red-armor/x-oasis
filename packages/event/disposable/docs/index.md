...
```bash
npm install @x-oasis/disposable
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/disposable';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/event/disposable)
...
```typescript
import { /* types */ } from '@x-oasis/disposable';
```
...
- Other packages in [event](/packages/event/)
- Similar functionality in other categories

## See Also

- [Package Category](/packages/event/)
