...
```bash
npm install @x-oasis/emitter
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/emitter';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/event/emitter)
...
```typescript
import { /* types */ } from '@x-oasis/emitter';
```
