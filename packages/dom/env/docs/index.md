...
Detect DOM environment information

## Installation

```bash
npm install @x-oasis/env
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/env';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/dom/env)
