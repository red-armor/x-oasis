...
Bind and manage DOM event listeners

## Installation

```bash
npm install @x-oasis/bind-events
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/bind-events';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/dom/bind-events)
...
```typescript
import { /* types */ } from '@x-oasis/bind-events';
```
