# @x-oasis/in-bounding-box

Check if element is within a bounding box

## Installation

```bash
npm install @x-oasis/in-bounding-box
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/in-bounding-box';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/dom/in-bounding-box)
...
```typescript
import { /* types */ } from '@x-oasis/in-bounding-box';
```
...
- Other packages in [dom](/packages/dom/)
- Similar functionality in other categories

## See Also

- [Package Category](/packages/dom/)
