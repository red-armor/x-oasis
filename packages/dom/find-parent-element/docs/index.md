...
Traverse up DOM tree to find elements

## Installation

```bash
npm install @x-oasis/find-parent-element
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/find-parent-element';
...
See the source code on [GitHub](https://github.com/d-band/x-oasis/tree/main/packages/dom/find-parent-element)
...
```typescript
import { /* types */ } from '@x-oasis/find-parent-element';
```
