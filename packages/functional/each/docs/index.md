...
```bash
npm install @x-oasis/each
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/each';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/functional/each)
...
```typescript
import { /* types */ } from '@x-oasis/each';
```
