...
```bash
npm install @x-oasis/find-last-index
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/find-last-index';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/functional/find-last-index)
...
```typescript
import { /* types */ } from '@x-oasis/find-last-index';
```
