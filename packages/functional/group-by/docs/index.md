...
```bash
npm install @x-oasis/group-by
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/group-by';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/functional/group-by)
...
```typescript
import { /* types */ } from '@x-oasis/group-by';
```
