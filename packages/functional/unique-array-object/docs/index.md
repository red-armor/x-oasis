...
```bash
npm install @x-oasis/unique-array-object
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/unique-array-object';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/functional/unique-array-object)
...
```typescript
import { /* types */ } from '@x-oasis/unique-array-object';
```
...
- Other packages in [functional](/packages/functional/)
