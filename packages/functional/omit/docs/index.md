...
```bash
npm install @x-oasis/omit
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/omit';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/functional/omit)
...
```typescript
import { /* types */ } from '@x-oasis/omit';
```
