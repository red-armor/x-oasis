...
Get map key by its value

## Installation

```bash
npm install @x-oasis/get-map-key-by-value
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/get-map-key-by-value';
...
```typescript
import { /* types */ } from '@x-oasis/get-map-key-by-value';
```
