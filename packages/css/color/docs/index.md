...
```bash
npm install @x-oasis/color
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/color';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/css/color)
...
```typescript
import { /* types */ } from '@x-oasis/color';
```
...
- Other packages in [css](/packages/css/)
- Similar functionality in other categories

## See Also

- [Package Category](/packages/css/)
