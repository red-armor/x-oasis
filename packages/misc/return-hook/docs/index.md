...
Hook-based function return utilities

## Installation

```bash
npm install @x-oasis/return-hook
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/return-hook';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/misc/return-hook)
...
```typescript
import { /* types */ } from '@x-oasis/return-hook';
```
