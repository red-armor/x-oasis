...
```bash
npm install @x-oasis/id
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/id';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/misc/id)
