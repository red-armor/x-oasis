...
Get default number with type check

## Installation

```bash
npm install @x-oasis/default-number-value
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/default-number-value';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/misc/default-number-value)
...
```typescript
import { /* types */ } from '@x-oasis/default-number-value';
```
