...
Get default value if nullish

## Installation

```bash
npm install @x-oasis/default-value
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/default-value';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/misc/default-value)
...
```typescript
import { /* types */ } from '@x-oasis/default-value';
```
