...
```bash
npm install @x-oasis/capitalize
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/capitalize';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/misc/capitalize)
...
```typescript
import { /* types */ } from '@x-oasis/capitalize';
```
