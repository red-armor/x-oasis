...
Get default boolean with type check

## Installation

```bash
npm install @x-oasis/default-boolean-value
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/default-boolean-value';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/misc/default-boolean-value)
...
```typescript
import { /* types */ } from '@x-oasis/default-boolean-value';
```
...
- Other packages in [misc](/packages/misc/)
- Similar functionality in other categories

## See Also

- [Package Category](/packages/misc/)
