...
```bash
npm install @x-oasis/noop
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/noop';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/misc/noop)
...
```typescript
import { /* types */ } from '@x-oasis/noop';
```
