...
Check if a primitive value is empty

## Installation

```bash
npm install @x-oasis/is-primitive-empty
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/is-primitive-empty';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/assertion/is-primitive-empty)
...
```typescript
import { /* types */ } from '@x-oasis/is-primitive-empty';
```
...
- Other packages in [assertion](/packages/assertion/)
- Similar functionality in other categories

## See Also

- [Package Category](/packages/assertion/)
