...
```bash
npm install @x-oasis/is-promise
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/is-promise';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/assertion/is-promise)
...
```typescript
import { /* types */ } from '@x-oasis/is-promise';
```
