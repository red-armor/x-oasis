...
Check if a value is a class or class instance

## Installation

```bash
npm install @x-oasis/is-class
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/is-class';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/assertion/is-class)
...
```typescript
import { /* types */ } from '@x-oasis/is-class';
```
