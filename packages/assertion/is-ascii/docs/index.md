...
```bash
npm install @x-oasis/is-ascii
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/is-ascii';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/assertion/is-ascii)
...
```typescript
import { /* types */ } from '@x-oasis/is-ascii';
```
