...
```bash
npm install @x-oasis/is-function
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/is-function';
...
See the source code on [GitHub](https://github.com/d-band/x-oasis/tree/main/packages/assertion/is-function)
...
```typescript
import { /* types */ } from '@x-oasis/is-function';
```
