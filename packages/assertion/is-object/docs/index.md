...
```bash
npm install @x-oasis/is-object
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/is-object';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/assertion/is-object)
...
```typescript
import { /* types */ } from '@x-oasis/is-object';
```
