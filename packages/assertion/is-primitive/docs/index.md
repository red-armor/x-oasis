...
```bash
npm install @x-oasis/is-primitive
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/is-primitive';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/assertion/is-primitive)
...
```typescript
import { /* types */ } from '@x-oasis/is-primitive';
```
