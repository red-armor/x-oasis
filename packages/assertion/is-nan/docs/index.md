...
```bash
npm install @x-oasis/is-nan
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/is-nan';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/assertion/is-nan)
...
```typescript
import { /* types */ } from '@x-oasis/is-nan';
```
