...
```typescript
import { /* exports */ } from '@x-oasis/is-empty';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/assertion/is-empty)
...
```typescript
import { /* types */ } from '@x-oasis/is-empty';
```
