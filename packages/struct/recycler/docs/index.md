...
```bash
npm install @x-oasis/recycler
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/recycler';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/struct/recycler)
...
```typescript
import { /* types */ } from '@x-oasis/recycler';
```
