...
```bash
npm install @x-oasis/heap
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/heap';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/struct/heap)
...
```typescript
import { /* types */ } from '@x-oasis/heap';
```
