...
Efficient integer buffer set

## Installation

```bash
npm install @x-oasis/integer-buffer-set
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/integer-buffer-set';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/struct/integer-buffer-set)
...
```typescript
import { /* types */ } from '@x-oasis/integer-buffer-set';
```
