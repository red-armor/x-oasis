...
Prefix interval tree for ranges

## Installation

```bash
npm install @x-oasis/prefix-interval-tree
```

## Quick Start

```typescript
import { /* exports */ } from '@x-oasis/prefix-interval-tree';
...
See the source code on [GitHub](https://github.com/red-armor/x-oasis/tree/main/packages/struct/prefix-interval-tree)
...
```typescript
import { /* types */ } from '@x-oasis/prefix-interval-tree';
```
...
- Other packages in [struct](/packages/struct/)
- Similar functionality in other categories

## See Also

- [Package Category](/packages/struct/)
